...
function requestToKey(request, addTypename) {
    var queryString = request.query &&
        graphql.print(addTypename ? addTypenameToDocument(request.query) : request.query);
...
var MockLink = (function (_super) {
    ...
    MockLink.prototype.request = function (operation) {
        ...
        if (!response || typeof responseIndex === 'undefined') {
            this.onError(new Error("No more mocked responses for the query: " + graphql.print(operation.query) + ", variables: " + JSON.stringify(operation.variables)));
            return null;
        }
